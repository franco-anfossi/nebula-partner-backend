...
async def create_supplier(
    db: AsyncSession, company_id: int, description: str = None, keywords: str = None, category: str = None
) -> Supplier:
    """Create a new supplier profile and save it to the database."""
    new_supplier = Supplier(company_id=company_id, description=description, keywords=keywords, category=category)
    db.add(new_supplier)
    await db.commit()
